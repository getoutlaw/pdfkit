...
declare namespace PDFKit.Mixins {
  ...
  interface PDFAnnotation {
    ...
    fileAnnotation(
      ...
      w: number,
      h: number,
      file: AttachmentOptions & { src: Buffer | ArrayBuffer | string },
      option?: AnnotationOption
    ): this;
  }
  ...
  interface PDFAttachment {
    file(src: Buffer | ArrayBuffer | string, options?: AttachmentOptions): this;
  }
  ...
  interface PDFImage {
    ...
    openImage(src: any): { width: number; height: number };
  }
...
declare namespace PDFKit {
  ...
  interface PDFDocument
    ...
    continueOnNextPage(options?: PDFDocumentOptions): PDFDocument;
